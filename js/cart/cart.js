            ...
            fetch(cartEndpoint, {
                ...
                .then(data => {
                    ...
                    if (!items || items.length === 0) {
                        ...
                        items.forEach(item => {
                            ...
                            const itemHTML = `
                                    <div class="cart-item">
                                        ...
                                        <img class="product-image" data-sku="${product.sku}" src="https://res.cloudinary.com/cocomatik/${product.display_image}" alt="${product.name}" style="cursor: pointer;">
                                    </div>
                            ...
                            // Now attach click events to product images
                            const productImgs = cartContainer.querySelectorAll(".product-image");
                        ...
                        document.querySelectorAll(".summary-tax")[0].textContent = formatCurrency(totalMRP - totalActual); // Assuming 2nd .summary-tax is 'Total in Product Discount'
                        document.querySelectorAll(".summary-tax")[1].textContent = formatCurrency(totalActual); // Assuming 2nd .summary-tax is 'Total in Product Discount'
